export const customerColumns = [
  ...
  { key: 'referralCode', label: 'Referral Code', width: 130 },
  { key: 'city', label: 'City', width: 100 },
  { key: 'assignedSalesMemberName', label: 'Sales Rep', width: 120 },
...
export const customerDetailFields = [
  ...
  { key: 'assignedSalesMemberName', label: 'Sales Team Member' },
