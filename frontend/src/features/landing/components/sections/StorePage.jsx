...
export default function StorePage({ onClose }) {
  const { config, visible: configVisible } = useCMSStoreConfig();
  ...
  const hasAnyVisible = extras.heroVisible !== false || extras.extrasVisible !== false || configVisible !== false;
      ...
      <div className="max-w-7xl mx-auto">
        {!hasAnyVisible ? (
          <div className="py-28 text-center">
            <h2 className="text-2xl font-bold text-zinc-900 mb-2">Store information currently updating</h2>
            <p className="text-zinc-500 text-sm">Please check back shortly or contact support.</p>
          </div>
        ) : (
          <>
            {/* Hero Header */}
            {extras.heroVisible !== false && (
            ...
            {extras.extrasVisible !== false && extras.highlights?.length > 0 && (
