export const productDetailsFallback = {
  x1: {
    id: 'x1',
    name: 'X1',
    price: '₹70,000',
  ...
  hpro: {
    ...
    images: ['/Hprobg.webp', '/Hprobg.webp', '/Hprobg.webp'],
  ...
  ipro: {
    ...
    images: ['/iprobg.webp', '/iprobg.webp', '/iprobg.webp'],
    colors: ['Classic White', 'Sleek Black'],
    specs: {
  ...
  x4: {
    ...
    images: ['/x4bg.webp', '/x4bg.webp', '/x4bg.webp'],
    colors: ['Classic White', 'Sleek Black'],
    specs: {
  ...
  x3plus: {
    ...
    images: ['/bg-removebg-preview.webp', '/x3plusbg.webp', '/bg-removebg-preview.webp'],
    colors: ['Classic White', 'Sleek Black'],
    specs: {
  ...
  vacuum: {
    ...
    images: ['/appliance-vacuum.webp', '/appliance-vacuum.webp', '/appliance-vacuum.webp'],
  ...
  purifier: {
    ...
    images: ['/appliance-purifier.webp', '/appliance-purifier.webp', '/appliance-purifier.webp'],
  ...
  tv: {
    ...
    images: ['/appliance-tv.webp', '/appliance-tv.webp', '/appliance-tv.webp'],
  ...
  refri1: {
    ...
    images: ['/refri-removebg-preview.webp', '/refri-removebg-preview.webp', '/refri-removebg-preview.webp'],
  ...
  refri2: {
    ...
    images: ['/refri2-removebg-preview.webp', '/refri2-removebg-preview.webp', '/refri2-removebg-preview.webp'],
  ...
  mixer1: {
    ...
    images: ['/mixer1-removebg-preview.webp', '/mixer1-removebg-preview.webp', '/mixer1-removebg-preview.webp'],
  ...
  mixer2: {
    ...
    images: ['/mixer2-removebg-preview.webp', '/mixer2-removebg-preview.webp', '/mixer2-removebg-preview.webp'],
  ...
  tv2: {
    ...
    images: ['/tv2.webp', '/tv2.webp', '/tv2.webp'],
  ...
  tv3: {
    ...
    images: ['/tv3.webp', '/tv3.webp', '/tv3.webp'],
  ...
  tv4: {
    ...
    images: ['/tv4.webp', '/tv4.webp', '/tv4.webp'],
    colors: ['Midnight Black'],
    specs: {
  ...
  ac: {
    ...
    images: ['/ac-removebg-preview.webp', '/ac-removebg-preview.webp', '/ac-removebg-preview.webp'],
    colors: ['Arctic White'],
    specs: {
  ...
  er_passenger: {
    ...
    images: ['/haion-rickshaw.webp', '/haion-rickshaw.webp', '/haion-rickshaw.webp'],
