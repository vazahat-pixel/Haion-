export const ROUTES = {
  ...
  ADMIN_HRMS: '/admin/hrms',
  ADMIN_HRMS_EMPLOYEES: '/admin/hrms/employees',
  ADMIN_HRMS_ATTENDANCE: '/admin/hrms/attendance',
  ADMIN_HRMS_LEAVES: '/admin/hrms/leaves',
  ADMIN_HRMS_PAYROLL: '/admin/hrms/payroll',
  ADMIN_HRMS_DEPARTMENTS: '/admin/hrms/departments',
