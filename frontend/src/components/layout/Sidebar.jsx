      ...
      >
        ...
        {!isCollapsed && user && (
          <div className="shrink-0 border-t border-[var(--color-sidebar-border)] p-2 space-y-1">
            <div className="flex items-center gap-2 rounded-md bg-[var(--color-sidebar-surface)] px-2 py-1.5">
              <Avatar className="h-7 w-7">
                <AvatarFallback className="bg-brand-500/15 text-[10px] font-semibold text-brand-500">
                  {initials}
                </AvatarFallback>
              </Avatar>
              ...
              <span className="h-1.5 w-1.5 shrink-0 rounded-full bg-brand-500" title="Online" />
            </div>
            <Button
              variant="ghost"
              size="sm"
