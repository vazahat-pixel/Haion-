  ...
  admin: {
    ...
    nav: [
      ...
      },
      {
        ...
        icon: Users,
        path: ROUTES.ADMIN_HRMS_EMPLOYEES,
        permission: PERMISSIONS.EMPLOYEES_READ,
        roles: [ROLES.MASTER_ADMIN],
        section: '11. HRMS & WORKFORCE',
      },
      {
        ...
        icon: Clock,
        path: ROUTES.ADMIN_HRMS_ATTENDANCE,
        permission: PERMISSIONS.EMPLOYEES_READ,
        roles: [ROLES.MASTER_ADMIN],
        section: '11. HRMS & WORKFORCE',
      },
      ...
      },
      {
        ...
        icon: CreditCard,
        path: ROUTES.ADMIN_HRMS_PAYROLL,
        permission: PERMISSIONS.EMPLOYEES_READ,
        roles: [ROLES.MASTER_ADMIN],
        section: '11. HRMS & WORKFORCE',
      },
      {
        ...
        icon: Building2,
        path: ROUTES.ADMIN_HRMS_DEPARTMENTS,
        permission: PERMISSIONS.EMPLOYEES_READ,
        roles: [ROLES.MASTER_ADMIN],
        section: '11. HRMS & WORKFORCE',
      },
