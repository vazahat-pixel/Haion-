...
export const PANELS = {
  admin: {
    ...
    nav: [
      ...
      { id: 'sales-invoices', label: 'Sales Invoices', icon: FileText, path: ROUTES.ADMIN_SALES_INVOICES, permission: PERMISSIONS.PURCHASES_READ },
      { id: 'payment-in', label: 'Payment In', icon: ArrowDownCircle, path: ROUTES.ADMIN_PAYMENT_IN, permission: PERMISSIONS.PURCHASES_READ },
      { id: 'sale-po', label: 'Sale PO (Dealer Orders)', icon: ShoppingBag, path: ROUTES.ADMIN_SALE_PO, permission: PERMISSIONS.PURCHASES_READ },
      { id: 'payment-out', label: 'Payment Out', icon: ArrowUpCircle, path: ROUTES.ADMIN_PAYMENT_OUT, permission: PERMISSIONS.PURCHASES_READ },
      ...
      { id: 'dealer-invoices', label: 'Dealer Invoices', icon: Receipt, path: '/admin/dealer-invoices', permission: PERMISSIONS.DEALERS_READ, roles: [ROLES.MASTER_ADMIN] },
      { id: 'referrals', label: 'Referral Rewards', icon: Gift, path: ROUTES.ADMIN_REFERRALS, permission: PERMISSIONS.ANALYTICS_READ, roles: [ROLES.MASTER_ADMIN] },
      { id: 'service-centers', label: 'Service Centres', icon: Wrench, path: ROUTES.ADMIN_SERVICE_CENTERS, permission: PERMISSIONS.COMPLAINTS_READ, roles: [ROLES.MASTER_ADMIN] },
      { id: 'admin-complaints', label: 'Complaints', icon: Headphones, path: ROUTES.ADMIN_COMPLAINTS, permission: PERMISSIONS.COMPLAINTS_READ, roles: [ROLES.MASTER_ADMIN] },
      { id: 'admin-job-cards', label: 'Job Cards', icon: ScrollText, path: ROUTES.ADMIN_JOB_CARDS, permission: PERMISSIONS.COMPLAINTS_READ, roles: [ROLES.MASTER_ADMIN] },
      { id: 'admin-insurance', label: 'Insurance', icon: Shield, path: ROUTES.ADMIN_INSURANCE, permission: PERMISSIONS.INSURANCE_CLAIMS_READ, roles: [ROLES.MASTER_ADMIN] },
      { id: 'admin-dealer-sale-returns', label: 'Dealer Sale Returns', icon: RotateCcw, path: ROUTES.ADMIN_DEALER_SALE_RETURNS, permission: PERMISSIONS.SALE_RETURNS_READ, roles: [ROLES.MASTER_ADMIN] },
      { id: 'admin-dealer-purchase-returns', label: 'Dealer Purchase Returns', icon: Undo2, path: ROUTES.ADMIN_DEALER_PURCHASE_RETURNS, permission: PERMISSIONS.PURCHASE_RETURNS_READ, roles: [ROLES.MASTER_ADMIN] },
      ...
      { id: 'ledger', label: 'Party Ledger', icon: BookOpen, path: ROUTES.ADMIN_LEDGER, permission: PERMISSIONS.REPORTS_READ, roles: [ROLES.MASTER_ADMIN] },
      { id: 'company-ledger', label: 'Company Ledger', icon: IndianRupee, path: ROUTES.ADMIN_COMPANY_LEDGER, permission: PERMISSIONS.REPORTS_READ, roles: [ROLES.MASTER_ADMIN] },
